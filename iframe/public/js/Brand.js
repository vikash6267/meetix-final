...
let BRAND = {
    app: {
        language: 'en',
        name: 'Heimat Talks SFU',
        title: 'Heimat Talks SFU<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
    ...
    site: {
        title: 'Heimat Talks SFU, Free Video Calls, Messaging and Screen Sharing',
    ...
    meta: {
        description:
            'Heimat Talks SFU powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
            'webrtc, heimat talks, mediasoup, mediasoup-client, self hosted, voip, sip, real-time communications, chat, messaging, meet, webrtc stun, webrtc turn, webrtc p2p, webrtc sfu, video meeting, video chat, video conference, multi video chat, multi video conference, peer to peer, p2p, sfu, rtc, alternative to, zoom, microsoft teams, google meet, jitsi, meeting',
    },
    html: {
        features: true,
        teams: true,
    ...
    about: {
        imageUrl: '../images/heimattalk-logo.gif',
        title: '<strong>WebRTC SFU v1.8.21</strong>',
        html: `
            <button 
                id="support-button" 
            ...
            <a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=Heimat Talks SFU info"> 
                miroslav.pejic.85@gmail.com
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2025 Heimat Talks SFU, all rights reserved</span>
            <hr />
        `,
    },
    //...
