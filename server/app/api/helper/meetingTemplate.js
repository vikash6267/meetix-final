const meetingTemplate = ({ type, meetingName, scheduleDateTime, shortSummary, roomId,userId }) => {
  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        ${showCTA ? `<a class="btn" href="https://meet.mahitechnocrafts.in/join/${roomId}/${userId}">Join Meeting</a>` : ''}
        <div class="footer">
