...
module.exports = {
    ...
    security: {
         ...
         */
        jwt: {
            key: process.env.JWT_SECRET || 'heimattalksfu_jwt_secret',
     ...
     */
    api: {
        keySecret: process.env.API_SECRET || 'heimattalksfu_default_secret',
        allowed: {
    ...
    ui: {
        ...
        brand: {
            ...
            app: {
                ...
                name: process.env.APP_NAME || 'Meetix',
                title:
                    process.env.APP_TITLE ||
                    'Meetix <br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
            ...
            site: {
                title:
                    process.env.SITE_TITLE || '<h1>Meetix</h1>, Free Video Calls, Messaging and Screen Sharing',
                icon: process.env.SITE_ICON_PATH || '../images/vite.svg',
                appleTouchIcon: process.env.APPLE_TOUCH_ICON_PATH || '../images/vite.svg',
        ...
        buttons: {
            ...
            settings: {
                ...
                host_only_recording: process.env.HOST_ONLY_RECORDING !== 'true',
