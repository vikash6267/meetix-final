...
/**
 * Heimat Talks SFU - Client component
 *
...
const image = {
    about: '../images/heimattalk-logo.gif',
    avatar: '../images/heimattalksfu-logo.png',
...
handleSilentRecordingUploaded(data) {
  ...
  stopSilentRecording() {
    console.log("🛑 silentRecordingCommand");
...
console.log("response",response)
    ...
    handleLocalRecordingStop() {
        ...
        // Call the upload API
        fetch('https://meetix.mahitechnocrafts.inupload-video', {
            method: 'POST',
    ...
    selectFileToShare(peer_id, broadcast = false) {
        ...
        Swal.fire({
            allowOutsideClick: false,
            background: swalBackground,
            imageAlt: 'heimattalksfu-file-sharing',
